...
// saem desta lista e ganham `<Route>` explícita abaixo — a começar por
// "Terrains" (Terrenos). Convenção de sub-rota adotada aqui, para os
// próximos módulos do catálogo (Projetos, Unidades) seguirem igual:
// detalhe em "/<slug>/:id", criação em "/<slug>/novo" (edição não tem rota
// própria — é um dialog, fiel ao original).
const PAGES_WITH_REAL_ROUTE = ['Terrains'];
