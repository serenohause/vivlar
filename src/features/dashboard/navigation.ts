...
export const PAGE_LABELS: Record<string, PageLabelEntry> = {
  ...
  InvestmentContributionDetail: { label: 'Detalhe do Aporte', parent: 'InvestmentContributions' },
  InvestmentReturns: { label: 'Retornos', parent: 'Dashboard' },
  InvestmentReturnDetail: { label: 'Detalhe do Retorno', parent: 'InvestmentReturns' },
